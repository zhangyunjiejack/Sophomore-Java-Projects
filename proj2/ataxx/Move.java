...
class Move {
    ...
    boolean isExtend() {
        int colDif = Math.abs(col1() - col0());
        int rowDif = Math.abs(row1() - row0());
    ...
    public String toString() {
        if (isPass()) {
            ...
            String result = Character.toString(col0());
            result += Character.toString(row0());
            result += "-" + Character.toString(col1()) + row1() + ".";
            return result;
        }
    }
